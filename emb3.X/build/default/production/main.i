...
static task task_list[5];
static _Bool timer_configured = 0;

void timer_init(void);
_Bool create_task(func fn, uint16_t ms);
...
void ignition_system(void){
    ...
    if(GLOBAL_TEMPERATURE < adc_100(1) - 5) {
        PORTCbits.RC5 = 0;
    }


    else if(GLOBAL_TEMPERATURE > adc_100(1) + 5) {
